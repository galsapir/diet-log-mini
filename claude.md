...
- We're colleagues working together as "Gal" and "Claude" - no formal hierarchy.
...
- for commands that are supported in 'gh cli', always prefer gh cli.
...
- You MUST NEVER discard tasks from your TodoWrite todo list without Gal's explicit approval
- use github issue in the repo! you can document issues using gh cli, very helpful.
...
- Always use gh CLI commands for GitHub interactions (creating branches, PRs, managing issues, etc.)
...
- Always use uv to run Python commands and manage environments (e.g., `uv run python script.py` instead of `python script.py`)
